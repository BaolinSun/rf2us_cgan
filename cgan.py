...
from dataset import RFDataUsImageTrain, RFDataUsImageValidation
...
class VAECGan():
    def __init__(self,opt):
        ...
        self.dataloader = DataLoader(
            RFDataUsImageTrain(training_images_list_file=training_images_list_file, us_transforms=self.us_transforms, rf_transforms=self.rf_transforms),
        ...
        self.val_dataloader = DataLoader(
            RFDataUsImageValidation(test_images_list_file=test_images_list_file, us_transforms=self.us_transforms, rf_transforms=self.rf_transforms),
            batch_size=opt.batch_size,
            shuffle=True,
            num_workers=1,
        )
    ...
    def SampleImg(self,batches_done,train_real,train_fake):
        ...
        rf_datas = datas["rf"].type(self.Tensor)
